...
export function AppFunction() {
	...
	return (
		...
		<View style={{ flex: 1 }}>
			...
			<Image style={{ flex: 1, resizeMode: "cover" }} source={{ uri: "https://iphoneros.com/wp-content/uploads/2018/07/macbookpro2018.jpg" }} />
					...
					<View >
						...
						<TouchableOpacity>
							<View style={{ alignItems: "center", justifyContent: "center", }}>
								<Image style={{ height: 100, width: 100, borderRadius: 50 }} source={{ uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQIiloJS8J1_AXSqs8HqClMuUPLuniwnGjWJGHDjFJnnvrHpzkt&usqp=CAU" }} />
							</View>
						</TouchableOpacity>

						<View style={styles.counterNumber}>
							<View style={{ backgroundColor: "red", borderColor: "red", padding: 50, borderRadius: 25 }}>
						...
						<View style={{ flexDirection: "row", justifyContent: "center" }}>
							...
							<TouchableOpacity style={styles.touchDisminuir} onPress={disminuir}>
